...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'buenosairesvision_backup_3ef4fca15b62ecad7031_20230513211648_archive.zip';
        const ARCHIVE_SIZE       = '127611967';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3ef4fca-13211648';
        const SECONDARY_PACKAGE_HASH = 'ed0f524-13211648';
        const VERSION            = '1.5.4';
